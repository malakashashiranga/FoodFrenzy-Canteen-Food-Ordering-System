...
orderButtonMiddle.addEventListener("click", function () {
	window.location.href = "/FoodFrenzy-Canteen-Food-Ordering-System/FoodFrenzy/application/frontend/php/pages/register user/foods/food_page.php";
});

readMoreButton.addEventListener("click", function () {
	window.location.href = "/FoodFrenzy-Canteen-Food-Ordering-System/FoodFrenzy/application/frontend/php/pages/unregister user/about us/about_us.php";
});

showMoreFoods.addEventListener("click", function () {
	window.location.href = "/FoodFrenzy-Canteen-Food-Ordering-System/FoodFrenzy/application/frontend/php/pages/unregister user/food page/food_page.php";
});
