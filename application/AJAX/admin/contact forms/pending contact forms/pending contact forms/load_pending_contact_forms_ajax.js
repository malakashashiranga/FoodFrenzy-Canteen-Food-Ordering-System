$(document).ready(function() {
    ...
    function loadContactFormDetails() {
        $.ajax({
            url: '/FoodFrenzy/application/backend/php/admin/contact forms/pending contact forms/pending contact forms/load_pending_contact_forms.php',
            type: "POST",
            dataType: "json",
            data: {},
            success: function(data) {
                if (data.success) {
                    if (data.noContactForms) {
                        ...
                        data.contactFormsDetails.forEach(function(cForm) {
                            ...
                            formRow.on("click", function() {
                                ...
                                window.location.href = `/FoodFrenzy/application/backend/php/admin/contact forms/pending contact forms/redirect to specific contact form/redirect_to_specific_contact_form.php?form_number=${formNumber}`;
                            });
                    ...
                    if (data.error_page) {
                        ...
                        const goBackURL = "/FoodFrenzy/application/frontend/php/pages/admin/contact forms/pending contact forms/pending contact forms/pending_contact_forms_page.php";
