$(document).ready(function() {
    $('.ajax-button').click(function(event) { 
        ...
        $.ajax({
            url: '/FoodFrenzy-Canteen-Food-Ordering-System/application/backend/php/admin/menu/manage food details/manage specific food details/button clicks/buttons_clicks.php',
            method: 'POST',
            data: formData,
			dataType: 'json',
			contentType: false,
