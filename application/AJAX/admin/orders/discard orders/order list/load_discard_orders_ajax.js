$(document).ready(function() {
    ...
    function loadPendingOrders(searchTerm = "") {
        ...
        $.ajax({
            url: '/FoodFrenzy-Canteen-Food-Ordering-System/application/backend/php/admin/orders/discard orders/order list/load_discard_orders_to_page.php',
            type: "POST",
            dataType: "json",
            ...
            success: function(data) {
				if (data.success) {
					...
					if (data.noFoods) {
						...
						data.ordersDetails.forEach(function (order) {
							...
							orderRow.on("click", function() {
								...
								window.location.href = `/FoodFrenzy-Canteen-Food-Ordering-System/application/backend/php/admin/orders/discard orders/redirect to specific discard order/redirect_to_specific_discard_orders.php?orderID=${encodedOrderID}`;
							});
					...
					if (data.error_page) {
						...
						const goBackURL = "/FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/admin/orders/discard orders/order list/discard_orders.php"; 
