$(document).ready(function() {
    ...
    function loadUsersDetails(searchTerm = "") {
        ...
        $.ajax({
            url: '/FoodFrenzy-Canteen-Food-Ordering-System/application/backend/php/admin/users/user details/user list/load_users_details.php',
            type: "POST",
            dataType: "json",
            ...
            success: function(data) {
				if (data.success) {
					...
					if (data.noFoods) {
						...
						data.userDetails.forEach(function (userDetails) {
							...
							orderRow.on("click", function() {
								...
								window.location.href = `/FoodFrenzy-Canteen-Food-Ordering-System/application/backend/php/admin/users/user details/redirect to specific user details/redirect_to_specific_user_details.php?userID=${encodedUserID}`;
							});
					...
					if (data.error_page) {
						...
						const goBackURL = "/FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/admin/users/user details/user list/users_details.php"; 
