$(document).ready(function () {
    function fetchFoodDetails() {
        $.ajax({
            url: '/FoodFrenzy-Canteen-Food-Ordering-System/application/backend/php/register and unregister user/load foods/load_foods.php',
            type: "POST",
            dataType: "json",
            data: {},
            success: function (data) {
                if (data.success) {
                    ...
                    if (data.error_page) {
                        ...
                        const goBackURL = "/FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/register user/home_page.php";
