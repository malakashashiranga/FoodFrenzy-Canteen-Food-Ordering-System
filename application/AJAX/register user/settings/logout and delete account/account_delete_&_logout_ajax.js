$(document).ready(function() {
    $("#alert_second_btn").click(function(event) { 
        ...
        $.ajax({
            url: '/FoodFrenzy/application/backend/php/register user/settings/logout and delete account/logout_&_delete_account.php',
            method: 'POST',
            ...
            success: function(data) {
                if (data.success) {
					...
					if (data.alertType === 'delete_acc'){
						const newPageURL = '/FoodFrenzy/application/backend/php/register user/settings/send account delete message/send_email_message.php';
