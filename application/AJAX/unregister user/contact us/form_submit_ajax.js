$(document).ready(function () {
    ...
    contactForm.submit(function (event) {
        ...
        $.ajax({
            url: '/FoodFrenzy-Canteen-Food-Ordering-System/application/backend/php/register and unregister user/submit contact form/submit_contact_form.php',
            method: 'POST',
            data: formData,
            dataType: 'json',
            success: function (data) {
                ...
                if (data.success) {
					...
					if (data.error_page) {
						...
						const goBackURL = "/FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/unregister user/contact us/contacts.php"; 
