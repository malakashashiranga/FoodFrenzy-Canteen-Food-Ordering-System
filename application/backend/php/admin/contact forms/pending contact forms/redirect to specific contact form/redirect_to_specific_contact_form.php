			...
			if ($stmt = $conn->prepare($retriveContactFormDetails)) {
				...
				if ($result->num_rows > 0) {
					while ($row = $result->fetch_assoc()) {
						...
						header('Location: /FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/admin/contact forms/pending contact forms/manage pending contact form/specific_pending_contact_form_page.php');
					}
				} else {
...
function redirectToErrorPage($errorMessage) {
    ...
    $goBackURL = "/FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/admin/contact forms/pending contact forms/pending contact forms/pending_contact_forms_page.php"; 
