        ...
        if ($conn_status === "successfully") {			
			...
			if ($stmt = $conn->prepare($retrivePendingOrders)) {
				...
				if ($result->num_rows > 0) {
					...
					header('Location: /FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/admin/orders/discard orders/specific discard order/specific_discard_order.php');
				} else {
...
function redirectToErrorPage($errorMessage) {
    ...
    $goBackURL = "/FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/admin/orders/discard orders/order list/discard_orders.php"; 
