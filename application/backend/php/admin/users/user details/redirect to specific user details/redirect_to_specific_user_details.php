        ...
        if ($conn_status === "successfully") {			
			...
			if ($stmt = $conn->prepare($retriveUserDetails)) {
				...
				if ($result->num_rows > 0) {
					...
					header('Location: /FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/admin/users/user details/specific user details/specific_user_details.php');
				} else {
...
function redirectToErrorPage($errorMessage) {
    ...
    $goBackURL = "/FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/php/pages/admin/users/user details/user list/users_details.php"; 
