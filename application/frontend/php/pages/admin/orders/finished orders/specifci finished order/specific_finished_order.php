...
<?php
	if (isset($_SESSION['specific_order_details'])) {
	   ...
	   header('Location: /FoodFrenzy/application/frontend/php/pages/admin/orders/finished orders/order list/finished_orders.php'); 
	}
?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/FoodFrenzy/application/frontend/css/pages/admin/orders/finished orders/specific finished order/specific_finished_order.css">
</head>
<body>  
		...
		<div class="mid_container">
			<div id= "specific_finished_order_form">
				<div class="image_part" id="">
					<img id="user_image" name="user_image" class="container_image" src="<?php echo isset($finishedOrderDetails['userPhotoPath']) ? '/FoodFrenzy/storage/photos/users/'.urlencode(strtolower($finishedOrderDetails['userID'])). '/' . urlencode($finishedOrderDetails['userPhotoPath']) : '/FoodFrenzy/storage/photos/users/default user/default_user.svg'; ?>" alt="userImage">
				</div>
	...
	<script src="/FoodFrenzy/application/frontend/javascript/pages/admin/orders/finished orders/specific finished order/specific_finished_order.js"></script>
