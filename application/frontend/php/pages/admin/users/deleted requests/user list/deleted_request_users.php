...
<body>  
	...
	<script src="/FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/javascript/pages/admin/users/deleted requests/user list/deleted_request_users.js"></script>
	<script src="/FoodFrenzy-Canteen-Food-Ordering-System/application/AJAX/admin/users/deleted requests/user list/load_deleted_request_users_ajax.js"></script>
