...
<head>
    ...
    <link rel="stylesheet" href="/FoodFrenzy-Canteen-Food-Ordering-System/application/frontend/css/pages/register/foods/food_page.css">
...
<body>
	<div class="fullScreen">
		<div class="f_st_part"> 
			...
			?>
			<img src="/FoodFrenzy-Canteen-Food-Ordering-System/storage/photos/system/pizza_table.jpg" alt="wallpaper" id="wallpaper"> 
	...
	<script src="/FoodFrenzy-Canteen-Food-Ordering-System/application/AJAX/register user/foods page/load foods/load_foods_ajax.js"></script>
	<script src="/FoodFrenzy-Canteen-Food-Ordering-System/application/AJAX/register user/foods page/foods add to cart/food_add_to_cart_ajax.js"></script>
